...
def update_volunteer(volunteer_id: int, data: Optional[UpdateVolunteer] = None):
    if data is None or (data.nome is None and data.email is None and data.cargo_pretendido is None and data.disponibilidade is None):
